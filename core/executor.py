...
Report generated by: WriterAgent | Audience: {audience}"""
    ...
    def run_command(self, params):
        ...
        try:
            if os.name == "nt" and base == "echo":
                run_args = ["cmd", "/c", *command_parts]
            else:
                run_args = command_parts

            result = subprocess.run(run_args, shell=False, capture_output=True, text=True, timeout=5)
    ...
    def modify_config(self, params):
        ...
        os.makedirs("output_config", exist_ok=True)
        config_path = "output_config/system_config.json"
